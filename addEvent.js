...
const contractAddresses = require("./constant/networkMapping")
const chainId = process.env.chainID || 31337
const contractAddress = contractAddresses[chainId]["NFTmarketplace"][0] //this means that go to networkMapping pick the chainid from chainid pich nftmarketplace and from them pich 0 element
